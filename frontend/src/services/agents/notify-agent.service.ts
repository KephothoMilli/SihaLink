...
export class NotifyAgentService {
    ...
    */
    async sendNotification(request: NotificationPayload): Promise<NotificationResult> {
    ...
    */
    async getNotificationHistory(encounterId: string): Promise<NotificationResult[]> {
    ...
    */
    ...
    async healthCheck(): Promise<boolean> {
        try {
            return await this.api.get('/health/notify');
        } catch {
            return false;
        }
    }
